...
export default function SkillsSection() {
  ...
  return (
    <section
      id="skills"
      className="bg-[#0b0f17] text-white py-8 px-4 md:py-16 md:px-12 scroll-mt-12 md:scroll-mt-6 border-b border-gray-800 font-sans"
    >
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {Object.entries(technicalSkills || {}).map(([title, skills]) => (
            <div
              key={title}
              className="bg-[#11161d] border border-gray-800/80 rounded-xl p-3 md:p-6 flex flex-col justify-between"
            >
              {/* Dynamic Heading */}
